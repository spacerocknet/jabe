...
object TestUidBlockDAO {
  def main(args: Array[String]): Unit = {
    ...
    running(app) {
      ...
      l.add("5")
      l.add("6")
      ub.addNewBlock(1, l.toSet, false, -1)
      l.clear()
      l.add("7")
      l.add("8")
      l.add("9")
      l.add("10")
      ub.addNewBlock(2, l.toSet, false, -1)
      l.clear()
      l.add("10")
      l.add("11")
      l.add("12")
      l.add("13")
      ub.addNewBlock(3, l.toSet, false, -1)
      l.clear()
      l.add("14")
      l.add("16")
      l.add("30")
      l.add("22")
      ub.addNewBlock(4, l.toSet, false, -1)

      ub.assignBlockToServer(2, 1)
      var n: Int = ub.getNextBlockId()
      println(n)
      ub.assignBlockToServer(n, 1)
      n = ub.getNextBlockId()
      println(n)
      ub.assignBlockToServer(n, 1)
